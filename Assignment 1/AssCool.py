...
#        self.screenheight = self.root.winfo_screenheight()
        ...
        #setting window size
        self.general_x_position = self.screenwidth // 4


        self.button_trigger2=ttk.Button(self.root)
        self.button_trigger2["text"] = "Refresh"
        self.button_trigger2.place(x=self.general_x_position,y=310,width=70,height=56)
        ...
        self.button_color_trigger1.place(x=self.general_x_position - 15,y=460,width=100,height=25)

        self.entry_1 = ttk.Entry(self.root)
        self.entry_1.place(x=self.general_x_position - 15,y=370,width=100,height=25)

        self.entry_2 = ttk.Entry(self.root)
        self.entry_2.place(x=self.general_x_position - 15,y=400,width=100,height=25)

        self.entry_1_lable_1 = ttk.Label(self.root)
        self.entry_1_lable_1["text"] = "from: "
        self.entry_1_lable_1.place(x=self.general_x_position - 60,y=370,width=40,height=25)

        self.entry_2_lable_1 = ttk.Label(self.root)
        self.entry_2_lable_1["text"] = "to: "
        self.entry_2_lable_1.place(x=self.general_x_position - 55,y=400,width=40,height=25)

        self.button_trigger3 = ttk.Button(self.root)
        self.button_trigger3["text"] = "Run Step"
        self.button_trigger3.place(x=self.general_x_position - 10,y=430,width=80,height=25)
        self.button_trigger3["command"] = self.button_trigger3_command

        self.button_trigger3_restrict_mode = ttk.Button(self.root)
        self.button_trigger3_restrict_mode.place(x=self.general_x_position - 40,y=490,width=150,height=25)
        ...
        self.message_box1.place(x=self.general_x_position - 100,y=30,width=296,height=231)
        ...
        self.button_trigger4.place(x=self.general_x_position - 70,y=280,width=226,height=25)
            #?# information box trigger
        #!# information_box
    ...
    def disable_information_box(self):
        ...
        if not self.hide_status:
            self.message_box2_rules.place(x=0,y=0,width=100,height = self.screenheight // 2)
            self.message_box3_debug_window.place(x=self.screenwidth // 2 - 100,y=0,width=100,height = self.screenheight // 2)
